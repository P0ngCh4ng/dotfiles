...
(defvar my-gabagefile)
(defvar my-worktodofile)
(defvar my-todofile)
...
;; Declare functions from external packages to suppress byte-compile warnings
(declare-function global-flycheck-mode "flycheck")
(declare-function flycheck-add-mode "flycheck")
(declare-function exec-path-from-shell-initialize "exec-path-from-shell")
(declare-function global-aggressive-indent-mode "aggressive-indent")
...
(declare-function beacon-mode "beacon")
(declare-function org-agenda-clockreport-mode "org-agenda")
...
(declare-function stylish-haskell-enable "stylish-haskell")
(declare-function stylish-haskell-disable "stylish-haskell")
...
;; Fix helm-grep-match face warnings (must be after helm loads)
...
;; haskell-customize, haskell-interactive-mode, haskell-cabal are built-in to haskell-mode
(with-eval-after-load 'haskell-mode
  ...
  (add-hook 'haskell-mode-hook 'stylish-haskell-setup))
...
(setq my-gabagefile (concat (getenv "HOME") "/org/gabage.org"))
(setq my-worktodofile (concat (getenv "HOME") "/org/worktodo.org"))
(setq my-todofile (concat (getenv "HOME") "/org/todo.org"))
;; org-capture is built-in to org
(with-eval-after-load 'org
  (require 'org-capture)
  (setq org-capture-templates
        '(("w" "WorkTodo" entry (file+headline my-worktodofile "workTODO")
	   "* TODO %?\n %i\n %a")
	  ("g" "Gabage" entry (file+headline my-gabagefile "gabage")
	   "*  Gabage %?\n %U\n %i\n %a")
          ("t" "Todo" entry (file+headline my-todofile "TODO")
           "* TODO %?\n %U\n %i\n %a"))))
;; メモをC-M-^一発で見るための設定
...
(defun my/advance-todos-schedule-from-today (time-string)
  "Interactively advance the schedule time of TODOs from today's TIME-STRING.
Advances TODOs with names and seconds in TODO-NAMES-SECONDS."
